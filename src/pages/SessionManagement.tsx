...
function SessionManagement() {
  ...
  async function startsRecordingProposals() {
    if (active) {
      ...
      try {
        const startRecording = await contract.startsRecordingProposals();
    ...
    <div>
      <Paper shadow="xs" p="md">
        ...
        <Grid gutter="xl">
          ...
          <Grid.Col span={6}>
            <Button color="red" onClick={stopRecordingProposals} uppercase>
          ...
          <Grid.Col span={6}>
            <Button color="red" onClick={stopVotingSession} uppercase>
              stop vote
            </Button>
          </Grid.Col>
          <Grid.Col span={12}>
          ...
          <Grid.Col span={12}>
            <Title order={3}>
              <Button color="orange" onClick={voteTallying} uppercase>
                Vote Tayling
              </Button>
            </Title>
          </Grid.Col>
